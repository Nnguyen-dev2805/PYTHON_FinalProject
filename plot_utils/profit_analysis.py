...
def highest_profit_month(df):
    ...
    # chuyển cột release_date thành kiểu datetime
    df['release_date'] = pd.to_datetime(df['release_date'])

    # đặt cột release_date làm chỉ số cho DataFrame
    releasedate_index = df.set_index("release_date")
    #nhóm dữ liệu theo tháng lấy ra tháng từ release_date và tính tổng lợi nhuận tổng giá trị strong cột profit cho mỗi tháng
